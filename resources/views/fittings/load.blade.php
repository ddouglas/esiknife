                ...
                <div class="list-group">
                    ...
                    @if (isset($groups) && $groups->isNotEmpty())
                        ...
                        @foreach ($groups as $group)
                            <a href="{{ route('fittings.load', ['group' => $group->get('id')]) }}" class="list-group-item">{{ $group->get('name') }}</a>
                        @endforeach
                    @else
                        <div class="list-group-item">
            ...
            <div class="col-lg-8">
                ...
                <div class="list-group">
                        ...
                        @foreach ($fittings as $fitting)
                            <div class="list-group-item">
                                <div class="float-right">
                                    <div class="btn-group">
                                        <a href="{{ route('fittings.load', ['action' => 'save', 'id' => $fitting->get('fitting_id')]) }}" class="btn btn-primary">
                    ...
                    @else
                        ...
                        @else
                            <div class="list-group-item">
                                There are no fits currently in that group. Please try another group. To clear the filter, click the "All" button at the top of the menu to the left.
                            </div>
                        @endif
                    @endif
                </div>
